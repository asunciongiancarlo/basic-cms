...
class Blog extends \Eloquent {
	...
	public static function index()
	{
		return DB::table('blogs')
			 ->select('blogs.id as id','blog_title','blog_publish','image_name as blog_image','blog_intro','blog_featured','price','blog_sale')
	...
	{
		return DB::table('blogs')
			 ->select('blogs.id as id','blog_title','blog_publish','image_name as blog_image','blog_intro','price','blog_sale','blogs.created_at as created_at')
			 ->leftjoin('blog_images','blogs.id','=','blog_images.blog_id')
			 ->where('primary_image','=',1)
